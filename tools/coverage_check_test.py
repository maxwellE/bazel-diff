...
#   - one integration-test source that should be stripped entirely
SIMPLE_LCOV = """\
SF:src/hash.rs
LF:10
LH:9
...
class ParseLcovTest(unittest.TestCase):
    def test_extracts_per_file_records(self):
        ...
        self.assertEqual(records[0].path, "src/hash.rs")
...
class MainTest(unittest.TestCase):
    ...
    def test_no_main_source_lines_exits_2(self):
        # Only a test source -- nothing matches the production include prefix.
